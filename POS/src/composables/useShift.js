...
export function useShift() {
	...
	const checkOpeningShift = createResource({
		url: "posnext.api.shifts.check_opening_shift",
		auto: false,
		onSuccess(data) {
			if (data) {
				shiftState.value = {
	...
	const createOpeningShift = createResource({
		url: "posnext.api.shifts.create_opening_shift",
	...
	const getClosingShiftData = createResource({
		url: "posnext.api.shifts.get_closing_shift_data",
	...
	const submitClosingShift = createResource({
		url: "posnext.api.shifts.submit_closing_shift",
